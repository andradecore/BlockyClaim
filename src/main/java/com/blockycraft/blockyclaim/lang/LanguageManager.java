package com.blockycraft.blockyclaim.lang;
...
public class LanguageManager {
    ...
    public LanguageManager(BlockyClaim plugin) {
        this.plugin = plugin;
        loadLanguages();
    }
    ...
    public String get(String lang, String key, Map<String, String> placeholders) {
        ...
        String prefix = messages.getOrDefault(lang, messages.get(defaultLang)).getProperty("prefixo", "");
